...
def plot_energy_gradient(energy, gradient, label_e):
    ...
    # Plot
    ax1.plot(energy, marker='+', markersize=10, linewidth=2, label='Energy', color='r')
    ax2.plot(gradient, marker='+', markersize=10,  linewidth=2, label='Gradient', color='b')
    ...
    ax1.set_xlabel('Nomber of step (count)', fontsize=20)
    ax1.set_ylabel(label_e, fontsize=20)
    ax2.set_ylabel('Gradient norm (Hartree/Bohr)', fontsize=20, rotation =-90, labelpad=25)
